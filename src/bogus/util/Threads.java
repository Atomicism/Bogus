...
public class Threads{
    ...
    static Logger logger = new Logger("Threads");
    ...
    public static <T> T await(Future<T> future){
        try{
            ...
            throw new BogusRuntimeException(ex.getCause());
        }
    }
    ...
    public static ExecutorService executor(@Nullable String name){
        return executor(name, 1/*OS.cores*/);
    }
    ...
    private static Thread newThread(Runnable r, @Nullable String name, boolean daemon){
        ...
        thread.setUncaughtExceptionHandler((t, e) -> logger.err(e.toString()));
        return thread;
    }
}